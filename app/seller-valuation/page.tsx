...
export const metadata: Metadata = {
  title: 'Your Home Estimate - Legendary Real Estate Services',
  description: 'Your Home EstimateWant To See An Area Report? × Email Address (must be valid) CONTINUE WITH EMAIL or Continue with Facebook Continue with Google By clicking on ',
};
