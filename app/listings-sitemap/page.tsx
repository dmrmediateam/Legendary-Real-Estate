...
export const metadata: Metadata = {
  title: 'Listings Sitemap - Legendary Real Estate Services',
  description: 'Listings SitemapBrowse All Homes | Legendary Real Estate ServicesSee All Homes by CitySee All Homes by Zip CodeSee All Homes by CountySee All Homes by Neighborh',
};
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="text-lg text-black/70 leading-relaxed font-serif mb-6" style={{ letterSpacing: '0.02em' }}>
            See All Homes by City
          </p>
          <p className="text-lg text-black/70 leading-relaxed font-serif mb-6" style={{ letterSpacing: '0.02em' }}>
            See All Homes by Zip Code
          </p>
          <p className="text-lg text-black/70 leading-relaxed font-serif mb-6" style={{ letterSpacing: '0.02em' }}>
            See All Homes by County
          </p>
          <p className="text-lg text-black/70 leading-relaxed font-serif mb-6" style={{ letterSpacing: '0.02em' }}>
            See All Homes by Neighborhood
          </p>
          <p className="text-lg text-black/70 leading-relaxed font-serif mb-6" style={{ letterSpacing: '0.02em' }}>
            See All Homes by Area
          </p>
          <p className="text-lg text-black/70 leading-relaxed font-serif mb-6" style={{ letterSpacing: '0.02em' }}>
