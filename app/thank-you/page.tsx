...
export const metadata: Metadata = {
  title: 'Thank you - Legendary Real Estate Services',
  description: 'Thank You Sign InUsername or EmailPasswordSign InDon\'t have an account yet? Register Forgot password?RegisterEmailPasswordRegisterAlready have an account? Sign ',
};
