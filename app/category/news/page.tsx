...
export const metadata: Metadata = {
  title: 'news - Legendary Real Estate Services',
  description: 'news The World’s Tallest Glass Tree Returns to Yerkes Observatory Read More » November 14, 2025 No Comments',
};
