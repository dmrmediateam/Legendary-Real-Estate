...
export const metadata: Metadata = {
  title: 'Areas - Legendary Real Estate Services',
  description: 'Areas Lake Geneva’s Best Family Neighborhoods in 2026: Where to Raise Kids on the Lake Read More » November 24, 2025 No Comments',
};
