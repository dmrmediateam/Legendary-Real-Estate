...
export const metadata: Metadata = {
  title: 'Uncategorized - Legendary Real Estate Services',
  description: '2025 Lake Geneva Real Estate: A Year of Plot Twists, Price Psychology, and ‘Wait, Did We Have a Bidding War… in November?!’ Read More » December 15, 2025 No Com',
};
