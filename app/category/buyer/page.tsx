...
export const metadata: Metadata = {
  title: 'Buyer - Legendary Real Estate Services',
  description: 'Lake Geneva Investment Properties: Short-Term Rental vs. Long-Term Returns Analysis Read More » September 22, 2025 No Comments',
};
