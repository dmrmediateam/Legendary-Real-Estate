...
export const metadata: Metadata = {
  title: 'Sell Your Home Quickly and for Top Dollar with Legendary Real Estate Services - Legendary Real Estate Services',
  description: 'Sell Your Home Quickly and for Top Dollar with Legendary Real Estate ServicesSelling your home is more than just putting it on the market—it’s about strategy, p',
};
