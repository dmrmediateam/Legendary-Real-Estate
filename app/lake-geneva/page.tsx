...
export const metadata: Metadata = {
  title: 'Lake Geneva - Legendary Real Estate Services',
  description: 'Skip to contentLake Geneva Sign InUsername or EmailPasswordSign InDon\'t have an account yet? Register Forgot password?RegisterEmailPasswordRegisterAlready have ',
};
