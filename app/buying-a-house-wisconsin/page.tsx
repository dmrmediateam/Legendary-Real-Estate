...
export const metadata: Metadata = {
  title: 'Find Your Dream Home with Legendary Real Estate Services - Legendary Real Estate Services',
  description: 'Find Your Dream Home with Legendary Real Estate ServicesBuying a home is one of the most significant decisions you’ll ever make. That’s why we’re here to guide ',
};
